// React takes a while to load, so you'll need to add this
// to ensure React exists at that point
window.addEventListener("load", () => {
  window["@qanary/spring-boot-health-check"] =
    /*
  Copy dist/webexport.js here
  only copy what comes after `this["@qanary/spring-boot-health-check"] =`
  */
    ...
    (function (require$$0) {
                ...
                fetch("".concat(springBootAppUrl, "/actuator"), {
                  headers: {
                    Authorization: "Basic ".concat(
                      window.btoa(
                        ""
                          .concat(credentials.username, ":")
                          .concat(credentials.password)
                      )
                    ),
                  },
                })
                    ...
                    fetch(actuatorData._links.health.href, {
                      ...
                      .then(function (healthResponse) {
                        if (
                          !(
                            healthResponse !== null &&
                            healthResponse !== void 0 &&
                            healthResponse.ok
                          )
                        ) {
                          setHealth({
                            status: SERVICE_STATUS.PROBLEM,
                            text: "The service's health endpoint responded with a non-2XX response code: ".concat(
              ...
              case "admin": {
                fetch("".concat(springBootAppUrl, "/admin/status"), {
                  ...
                  .then(function (response) {
                    if (
                      !(response !== null && response !== void 0 && response.ok)
                    ) {
      ...
      var inverseOfStatusComparisonTable = inverseOfTable(
        statusComparisonTable
      );
      ...
      useStorage$1.useStorage =
        useStorage$1.useSessionStorage =
        useStorage$1.useLocalStorage =
          void 0;
        ...
        (0, _react$1.useEffect)(function () {
          ...
          var intervalTimer = setInterval(function () {
            try {
              ...
              if (stateValue !== _parsedStorageValue)
                setStateValue(_parsedStorageValue);
            } catch (_error) {}
          }, checkIntervalMs);
      ...
      function SpringBootHealthCheck(_ref) {
        ...
        var _useLocalStorage3 = (0, _useStorage.useLocalStorage)(
            "username",
            ""
          ),
        ...
        var _useApplicationStatus = (0,
          _useApplicationStatus2.useApplicationStatus)(
            type,
            {
              username: username,
              password: password,
      ...
      */
        var shouldRenderCredentialsInput = Boolean(
          Number(
            (health === null || health === void 0 ? void 0 : health.status) ===
              "protected"
          ) &
        ...
        return /*#__PURE__*/ _react.default.createElement(
          "div",
          {
            ...
            title: "Status of "
              .concat(name, " (")
              .concat(springBootAppUrl, "): ")
              .concat(
                health === null || health === void 0 ? void 0 : health.status,
                "\nHealth of service: The "
              )
              .concat(name, " (")
              .concat(springBootAppUrl, ") is ")
          ...
          /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              name !== null && name !== void 0 ? name : springBootAppUrl
            ),
            ":",
            " ",
            /*#__PURE__*/ _react.default.createElement(
                ...
                shouldRenderCredentialsInput
                  ? /*#__PURE__*/ _react.default.createElement(
                      ...
                      /*#__PURE__*/ _react.default.createElement(
                        "div",
                        null,
                        "Enter credentials for basic auth if necessary"
                      ),
                      /*#__PURE__*/ _react.default.createElement(
                        "div",
                        null,
                        "WARNING: Your credentials will be stored in the local storage. Always clear it on public or shared computers after use."
                      ),
                      "Username:",
                      " ",
      ...
      (function (exports) {
        ...
        var _SpringBootHealthCheck = _interopRequireDefault(
          SpringBootHealthCheck$1
        );
